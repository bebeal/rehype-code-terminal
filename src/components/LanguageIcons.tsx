...
export type CodeLanguageProperties = {
  name: CodeLanguage;
  Icon?: React.ForwardRefExoticComponent<React.RefAttributes<SVGSVGElement> & React.SVGProps<SVGSVGElement>>;
  href?: string;
  extensions?: string[];
};
...
export const bash: CodeLanguageProperties = {
  name: 'bash',
  Icon: forwardRef((props?: React.SVGProps<SVGSVGElement>, ref?: React.Ref<SVGSVGElement>) => {
    return (
  ...
  Icon: forwardRef((props?: React.SVGProps<SVGSVGElement>, ref?: React.Ref<SVGSVGElement>) => {
    return (
      <svg ref={ref} {...props} viewBox="0 0 128 128">
        ...
        <path fill="#eee" d="M98 123.4c-16.5 0-30-13.4-30-30s13.4-30 30-30s30 13.4 30 30s-13.4 30-30 30zm0-56.6c-14.7 0-26.7 12-26.7 26.7s12 26.7 26.7 26.7s26.7-12 26.7-26.7s-12-26.7-26.7-26.7z" />{' '}
...
export const zig: CodeLanguageProperties = {
  name: 'zig',
  Icon: forwardRef((props?: React.SVGProps<SVGSVGElement>, ref?: React.Ref<SVGSVGElement>) => {
    return <svg ref={ref} {...props} viewBox="0 0 32 32">
      <polygon points="5.733 19.731 5.733 12.264 8.533 12.264 8.533 8.531 2 8.531 2 23.464 5.547 23.464 8.907 19.731 5.733 19.731" fill="#f7a41d" /><polygon points="26.453 8.531 23.093 12.264 26.267 12.264 26.267 19.731 23.467 19.731 23.467 23.464 30 23.464 30 8.531 26.453 8.531" fill="#f7a41d"/><polygon points="26.875 6.707 20.513 8.531 9.467 8.531 9.467 12.264 16.847 12.264 5.115 25.293 11.497 23.464 22.533 23.464 22.533 19.731 15.148 19.731 26.875 6.707" fill="#f7a41d"/>
    </svg>
  }),
